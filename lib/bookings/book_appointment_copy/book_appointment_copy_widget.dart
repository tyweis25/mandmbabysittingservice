...
class BookAppointmentCopyWidget extends StatefulWidget {
  const BookAppointmentCopyWidget({super.key});

  static String routeName = 'BookAppointmentCopy';
  static String routePath = '/bookAppointmentCopy';
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed(PaymentMethodScreenWidget.routeName);
                  },
                  text: 'Next',
