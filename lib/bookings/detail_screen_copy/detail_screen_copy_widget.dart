...
import 'detail_screen_copy_model.dart';
export 'detail_screen_copy_model.dart';

class DetailScreenCopyWidget extends StatefulWidget {
  const DetailScreenCopyWidget({
    super.key,
  ...
  static String routeName = 'DetailScreenCopy';
  static String routePath = '/detailScreenCopy';

  @override
  State<DetailScreenCopyWidget> createState() => _DetailScreenCopyWidgetState();
}

class _DetailScreenCopyWidgetState extends State<DetailScreenCopyWidget> {
  late DetailScreenCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailScreenCopyModel());
