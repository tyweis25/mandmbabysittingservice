...
/// Functions to query AvailabilitySlotsRecords (as a Stream and as a Future).
Future<int> queryAvailabilitySlotsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<AvailabilitySlotsRecord>> queryAvailabilitySlotsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<AvailabilitySlotsRecord>> queryAvailabilitySlotsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
